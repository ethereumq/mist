...
- What do you run?  (_Binary version from [releases](https://github.com/"Ethereum Quantum /mist/releases) or a development version from the [commandline](https://github.com/"Ethereum Quantum /mist#run-mist)_)
