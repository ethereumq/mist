...
- What do you run?  (_Binary version from [releases](https://github.com/ethereumq/mist/releases) or a development version from the [commandline](https://github.com/ethereumq/mist#run-mist)_)
