...
!define GROUPNAME "EthereumQuantum"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\EthereumQuantum"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Geth incoming peers (TCP:40303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gethq\unpacked\gethq.exe" "" "" "EthereumQuantum" 40303 "" "" ""
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:40303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gethq\unpacked\gethq.exe" "" "" "EthereumQuantum" "" 40303 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:40303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gethq\unpacked\gethq.exe" "" "" "EthereumQuantum" "" 40303 "" ""
