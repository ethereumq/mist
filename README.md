...
Please check the [Mist troubleshooting guide](https://github.com/ethereumq/mist/wiki).

Or the [Gitter Channel](https://gitter.im/ethereum/mist), to connect with the community for instant help.

## Installation

If you want to install the app from a pre-built version on the [release page](https://github.com/ethereumq/mist/releases),
...
Now you're ready to initialise Mist for development:
    ...
    $ git clone https://github.com/ethereumq/mist.git
    $ cd mist
    $ yarn
...
*NOTE: client-binaries (e.g. [geth](https://github.com/ethereumq/go-ethereum)) specified in [clientBinaries.json](https://github.com/ethereumq/mist/blob/master/clientBinaries.json) will be checked during every startup and downloaded if out-of-date, binaries are stored in the [config folder](#config-folder)*
