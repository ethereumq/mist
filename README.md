...
Please note that this repository is the Electron host for the Meteor based wallet dapp whose repository is located here: https://github.com/ethereumqq/meteor-dapp-wallet.

## Help and troubleshooting

Please check the [Mist troubleshooting guide](https://github.com/ethereumqq/mist/wiki).

Or the [Gitter Channel](https://gitter.im/ethereum/mist), to connect with the community for instant help.

## Installation

If you want to install the app from a pre-built version on the [release page](https://github.com/ethereumqq/mist/releases),
...
Now you're ready to initialise Mist for development:
    ...
    $ git clone https://github.com/ethereumqq/mist.git
    $ cd mist
    $ yarn
...
*NOTE: client-binaries (e.g. [geth](https://github.com/ethereumqq/go-ethereum)) specified in [clientBinaries.json](https://github.com/ethereumqq/mist/blob/master/clientBinaries.json) will be checked during every startup and downloaded if out-of-date, binaries are stored in the [config folder](#config-folder)*
...
To generate the Ethereum Quantum Wallet (this will pack the one Ðapp from https://github.com/ethereumqq/meteor-dapp-wallet):
