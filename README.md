...
Please check the [Mist troubleshooting guide](https://github.com/"Ethereum Quantum /mist/wiki).

Or the [Gitter Channel](https://gitter.im/ethereum/mist), to connect with the community for instant help.

## Installation

If you want to install the app from a pre-built version on the [release page](https://github.com/"Ethereum Quantum /mist/releases),
...
Now you're ready to initialise Mist for development:
    ...
    $ git clone https://github.com/"Ethereum Quantum /mist.git
    $ cd mist
    $ yarn
