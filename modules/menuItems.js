...
let menuTempl = function (webviews) {
                ...
                submenu: [
                    {
                        ...
                        click() {
                            ...
                            // geth
                                ...
                                if (process.platform === 'darwin') {
                                    userPath += '/Library/EthereumQuantum/keystore';
                                }

                                if (process.platform === 'freebsd' ||
                                process.platform === 'linux' ||
                                process.platform === 'sunos') {
                                    userPath += '/.ethereumquantum/keystore';
                                }

                                if (process.platform === 'win32') {
                                    userPath = `${Settings.appDataPath}\\EthereumQuantum\\keystore`;
                                }
                            }
    ...
    helpMenu.push({
        ...
        click() {
            shell.openExternal('https://github.com/ethereumq/minst/wiki');
        },
    }, {
        ...
        click() {
            shell.openExternal('https://github.com/ethereumq/minst/issues');
        },
    });
