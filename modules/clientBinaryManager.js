...
const BINARY_URL = 'https://raw.githubusercontent.com/ethereumq/mist/master/clientBinaries.json';

const ALLOWED_DOWNLOAD_URLS_REGEX =
    /^http:\/\/(?:(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.)?wallet.ethereumq\.org\/releases\/)(?:.+)/;  // eslint-disable-line max-len
